...
<div class="card-grid">
  ...
  <a class="project-card" href="../ssb-daily/index.html">
    ...
    <h3>SSB Analysis</h3>
    <p>Automated analysis of Statistics Norway (SSB) economic data. Pulls key indicators from the SSB JSON-stat API every 3 days via GitHub Actions and renders a fresh Quarto report.</p>
    <div class="tech-tags">
