...
**Data unavailable:** SSB tables 11653, 08668, 13931 returned no data or API error
...
**Data unavailable:** SSB tables 05196, 10634 returned no data or API error
**Fixes applied:** none (post scrapped — data-level issue, not a code bug)
...
**Data unavailable:** SSB tables 14700, 09189, 08307 returned no data or API error
**Fixes applied:** none (post scrapped — data-level issue, not a code bug)
...
**Data unavailable:** SSB tables 11386, 09481, 08484 returned no data or API error
**Fixes applied:** none (post scrapped — data-level issue, not a code bug)
