...
**Data unavailable:** SSB tables 09429, 05110, 07221, 06265 returned no data or API error
...
**Data unavailable:** SSB tables 13554, 12349, 06076 returned no data or API error
**Fixes applied:** none (post scrapped — data-level issue, not a code bug)
