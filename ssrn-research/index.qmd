...
Every two weeks, a Claude AI agent scans the last 14 days of arXiv preprints across three areas and surfaces the **top-5 most-trending papers per area**:

- **Data Science** — `stat.ML`, `cs.LG`, `stat.ME`, `stat.AP`
- **Finance** — `q-fin.*`
